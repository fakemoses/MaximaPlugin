...
<<<<<<< HEAD
            ...
            {
                store.AddDefinition(canv.plotStore.varNameYmin, new Entry(canv.plotStore.yMinRange.ToString("0.00", nfi)));
                store.AddDefinition(canv.plotStore.varNameYmax, new Entry(canv.plotStore.yMaxRange.ToString("0.00", nfi)));
            }
