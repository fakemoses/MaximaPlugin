...
//            factorZ = region.factorZ;
        ...
        public void AddDefs(SMath.Math.Store store)
        {
            ...
            {
                store.AddDefinition(canv.plotStore.varNameMouseX, new Entry(dMouseX.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameMouseY, new Entry(dMouseY.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameMouseWheel, new Entry(dMouseW.ToString(nfi)));
            }
            //VIEW
            if (canv.plotStore.viewRedirecting == PlotStore.State.Enable)
            {
                store.AddDefinition(canv.plotStore.varNameZenith, new Entry(canv.plotStore.zenith.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameAzimuth, new Entry(canv.plotStore.azimuth.ToString(nfi)));
            }
            //AXIS
            if (canv.plotStore.xRedirecting == PlotStore.State.Enable)
            {
                store.AddDefinition(canv.plotStore.varNameXmin, new Entry(canv.plotStore.xMinRange.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameXmax, new Entry(canv.plotStore.xMaxRange.ToString(nfi)));
            }
            if (canv.plotStore.yRedirecting == PlotStore.State.Enable)
            {
                store.AddDefinition(canv.plotStore.varNameYmin, new Entry(canv.plotStore.yMinRange.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameYmax, new Entry(canv.plotStore.yMaxRange.ToString(nfi)));
            }
            if (canv.plotStore.zRedirecting == PlotStore.State.Enable)
            {
                store.AddDefinition(canv.plotStore.varNameZmin, new Entry(canv.plotStore.zMinRange.ToString(nfi)));
                store.AddDefinition(canv.plotStore.varNameZmax, new Entry(canv.plotStore.zMaxRange.ToString(nfi)));
            }
